    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(color: type == BorderButtonType.active ? AppColor.primary : AppColor.secondaryText, fontSize: 20, fontWeight: type == BorderButtonType.active ? FontWeight.w700 : FontWeight.w400 ),
        ),
      ),
    );
  }
