...
import 'package:gympal/common_widget/language_row.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.separated(
          ...
          separatorBuilder: (context,index){return const Divider(color: Colors.black26,height:1,);}, itemCount: langArr.length),
