...
class _MenuViewState extends State<MenuView> {
  ...
  List menuArr = [
    ...
    {"name": "Admin", "image": "assets/img/admin_logo.jpg", "tag":"12"},
    {"name": "", "image": "assets/img/blank.jpg", "tag":"13"},
    {"name": "Mentor Support", "image": "assets/img/mentor.png", "tag":"14"},
    {"name": "", "image": "assets/img/blank.jpg", "tag":"15"},
  ];
                  ...
                  switch (mObj["tag"].toString()) {
                    ...
                    case "14":
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const MentorView()));
                    default:
                  }
                },
              );
